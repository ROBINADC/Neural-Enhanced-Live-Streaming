"""
Plot two PSNR-time lines: SR and raw.
...
FPS = 5
SMOOTH_VALUE = 10  # group every N data points and use their average
...
ax.plot(mins_smooth, srs_smooth, label='SR', linewidth=1.2)
ax.plot(mins_smooth, raws_smooth, label='Raw', linewidth=1.2)
