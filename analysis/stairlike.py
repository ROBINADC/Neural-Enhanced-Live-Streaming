"""
Plot the PSNR difference (i.e., quality gain) of one experiment.
...
FPS = 5
SMOOTH_VALUE = 5  # group every N data points and use their average
...
plt.axhline(y=0, color='gray', alpha=0.3, ls='-', linewidth=0.5)  # y=0 line
